...
<p align="center"><img src="../../img/loc-delivery-task-flow.svg" width="720" alt="送餐任務資料流:點餐系統下任務→上位機查桌位規劃路徑→下發速度指令→下位機控制馬達,odometry回報後上位機定位修正,反覆直到到點→語音提示取餐、托盤感測確認、返航"></p>
