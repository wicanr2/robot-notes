...
<p align="center"><img src="../../img/mqtt-mtls-flow.svg" width="720" alt="MQTT mTLS 連線流程:① TLS handshake 雙向憑證(加密+認證)→ ② MQTT CONNECT broker 認證 → CONNACK → ③ SUBSCRIBE/PUBLISH 時 broker 查 ACL 授權;每次 pub/sub 都再過 ACL"></p>
