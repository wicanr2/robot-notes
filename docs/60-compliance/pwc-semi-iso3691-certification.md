...
> 客戶或內部同事說「PwC / SEMI / ISO 3691 認證」時，到底誰是標準制定者、誰是顧問、誰能檢測、誰能發證？
...
> 本篇起點：`tmp/PwdSemiISO3691.md`。其中提到 PwC Taiwan、SEMI E187、ISO/IEC 17025 / 17065、ISO 3691-1 / 3691-4。以下整理成 repo 可讀的專欄。標準與認證制度會更新，實際引用前仍要以 SEMI、主管機關、客戶規範與檢測／驗證機構的最新文件為準。
